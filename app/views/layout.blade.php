    ...
    <div class="page-container">
        ...
        <div class="header ">
            ...
            @else
                <div class=" pull-right">
                    <div class="header-inner">
                        <a href="/users/login" class="btn btn-tag btn-tag-light btn-tag-rounded m-r-20"> Login</a>
                        <a href="/users/register" class="btn btn-tag btn-tag-dark btn-tag-rounded m-r-20"> Register</a>
                    </div>
                </div>
            @endif
